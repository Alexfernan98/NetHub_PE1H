...
import { fieldsForCategory, isAssignable, domainOf, DOMAINS, CAMERA_TYPES, HA_MODES, roleOptions, importColumns, FIELD_LABELS, headerToKey } from '@/lib/categoryFields';
  ...
  return (
    <Modal open={open} onClose={onClose} title="Nuevo activo" width={640}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <AssetFieldset form={form} setForm={setForm} categorySlug={form.categorySlug} locs={locs} depts={depts} show={{ purchaseDate: true }} />
